...
model = load_model('Krypto\Backend\krypto_model.h5')
import json
import random
import pickle
import numpy as np
...
words = pickle.load(open('Krypto\Backend\words.pkl','rb'))
classes = pickle.load(open('Krypto\Backend\classes.pkl','rb'))
import nltk
nltk.download('punkt')
